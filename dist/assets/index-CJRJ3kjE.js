import{r as s,j as e}from"./animation-vendor-CdhPfQVW.js";import{j as F,k as C,l as I,m as E,n as f,F as T}from"./index-C6rLB7PO.js";import{F as _,a as P,b as R,c as D}from"./index-q8OFSP72.js";import"./iconBase-Bo5QDCiS.js";function M(r=.15){const n=s.useRef(null),[c,d]=s.useState(!1);return s.useEffect(()=>{const a=n.current;if(!a)return;const l=new IntersectionObserver(([b])=>{b.isIntersecting&&(d(!0),l.unobserve(a))},{threshold:r});return l.observe(a),()=>l.disconnect()},[r]),[n,c]}function q(){const[r,n]=s.useState([]),[c,d]=s.useState(""),[a,l]=s.useState({name:"",email:"",phone:"",message:""}),[b,L]=s.useState(null),[g,u]=s.useState(!1),[x,h]=s.useState(!1),[j,w]=s.useState(""),[v,N]=M(.05);s.useEffect(()=>{const t=()=>{const o=new Date,z=new Date(o.toLocaleString("en-US",{timeZone:"Asia/Kolkata"})).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});w(z)};t();const i=setInterval(t,1e3);return()=>clearInterval(i)},[]);const y=t=>{r.includes(t)?n(r.filter(i=>i!==t)):n([...r,t])},p=t=>i=>l(o=>({...o,[t]:i.target.value})),k=["Performance Marketing","Video Production","Web Development","Branding & Design","Influencer Campaign"],S=["Starter Setup","Growth Engine","Enterprise Elite"];return e.jsxs("div",{style:{fontFamily:"'DM Sans', sans-serif",background:"#03010a",minHeight:"100vh",color:"#ffffff",overflow:"hidden",position:"relative"},children:[e.jsxs("div",{className:"absolute inset-0 pointer-events-none z-0 overflow-hidden",children:[e.jsx("div",{className:"absolute top-[-10%] right-[-10%] w-[650px] h-[650px] rounded-full bg-purple-600/10 blur-[130px]"}),e.jsx("div",{className:"absolute bottom-[-10%] left-[-10%] w-[650px] h-[650px] rounded-full bg-[#adfa3b]/5 blur-[130px]"}),e.jsx("div",{className:"absolute top-[40%] left-[30%] w-[400px] h-[400px] rounded-full bg-blue-500/5 blur-[120px]"}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full h-[60%] opacity-40",style:{backgroundImage:`
      ...
      `}),e.jsxs("div",{className:"relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-36 pb-32",children:[e.jsxs("div",{className:"split-grid grid lg:grid-cols-[1.1fr_1fr] gap-16 items-start",children:[e.jsxs("div",{className:"space-y-12",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-purple-500/20 bg-purple-500/5 text-[9px] uppercase tracking-[0.3em] text-purple-400 font-bold",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-400 animate-pulse"}),"GET IN TOUCH // BUZZIWAH"]}),e.jsxs("h1",{className:"text-4xl md:text-6xl font-black uppercase tracking-tight leading-[0.95] text-white",children:["LET'S BUILD ",e.jsx("br",{}),e.jsx("span",{className:"text-transparent bg-clip-text bg-gradient-to-r from-[#adfa3b] to-purple-400",children:"SOMETHING MAD."})]}),e.jsx("p",{className:"text-[#a3a3c2] text-base md:text-lg max-w-md font-medium leading-relaxed",children:"Have a campaign, brand challenge, or disruptive idea? Connect with our Gen Z digital squad."})]}),e.jsxs("div",{className:"glass-container p-6 space-y-4 max-w-md",children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-white/5 pb-4",children:[e.jsxs("span",{className:"text-[10px] uppercase font-bold tracking-widest text-white/40 flex items-center gap-1.5",children:[e.jsx(F,{className:"text-[#adfa3b]"})," Local Time (Bengaluru)"]}),e.jsxs("span",{className:"text-sm font-black text-white tracking-widest flex items-center gap-2",children:[e.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-[#adfa3b] animate-ping"}),j||"00:00:00 PM"]})]}),e.jsxs("div",{className:"flex items-center justify-between border-b border-white/5 pb-4",children:[e.jsx("span",{className:"text-[10px] uppercase font-bold tracking-widest text-white/40",children:"Response Speed"}),e.jsx("span",{className:"text-xs font-bold text-[#adfa3b]",children:"⚡ UNDER 12 HOURS"})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-[10px] uppercase font-bold tracking-widest text-white/40",children:"Project Capacity"}),e.jsx("span",{className:"text-xs font-bold text-white/80",children:"🔥 3 SPOTS REMAINING"})]})]}),e.jsxs("div",{className:"space-y-6 max-w-md",children:[e.jsxs("div",{className:"flex gap-4 items-start group",children:[e.jsx("div",{className:"w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-[#adfa3b] group-hover:border-[#adfa3b] transition-all",children:e.jsx(C,{size:16})}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1",children:"Base HQ"}),e.jsxs("p",{className:"text-xs text-white/80 leading-relaxed font-semibold",children:["No.4/2, 1st Main Road, West of Chord Road,",e.jsx("br",{}),"Rajajinagar Industrial Town, Bengaluru - 560010"]})]})]}),e.jsxs("div",{className:"flex gap-4 items-start group",children:[e.jsx("div",{className:"w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-[#adfa3b] group-hover:border-[#adfa3b] transition-all",children:e.jsx(I,{size:16})}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1",children:"Direct Mail"}),e.jsx("p",{className:"text-xs text-white/80 font-semibold group-hover:text-white transition-all",children:"connect@sripadastudios.com"})]})]}),e.jsxs("div",{className:"flex gap-4 items-start group",children:[e.jsx("div",{className:"w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-[#adfa3b] group-hover:border-[#adfa3b] transition-all",children:e.jsx(E,{size:16})}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1",children:"Call Line"}),e.jsx("p",{className:"text-xs text-white/80 font-semibold",children:"+91 99806 87439"})]})]})]}),e.jsxs("div",{className:"flex gap-4",children:[e.jsx("a",{href:"https://instagram.com",target:"_blank",rel:"noreferrer",className:"modern-social",children:e.jsx(_,{size:18})}),e.jsx("a",{href:"https://facebook.com",target:"_blank",rel:"noreferrer",className:"modern-social",children:e.jsx(P,{size:18})}),e.jsx("a",{href:"https://youtube.com",target:"_blank",rel:"noreferrer",className:"modern-social",children:e.jsx(R,{size:18})}),e.jsx("a",{href:"https://linkedin.com",target:"_blank",rel:"noreferrer",className:"modern-social",children:e.jsx(D,{size:18})})]})]}),e.jsxs("div",{ref:v,className:`reveal ${N?"show":""} glass-container p-8 md:p-12 relative overflow-hidden`,children:[g&&e.jsx("div",{className:"success-overlay",children:e.jsxs("div",{className:"text-center space-y-6 px-6",style:{animation:"bounceIn .6s ease"},children:[e.jsx("div",{className:"w-16 h-16 rounded-full bg-[#adfa3b]/10 border border-[#adfa3b] flex items-center justify-center mx-auto shadow-[0_0_20px_rgba(173,250,59,0.3)]",children:e.jsx(f,{size:28,className:"text-[#adfa3b]"})}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("h3",{className:"text-2xl font-black uppercase tracking-tight text-white",children:"PIPELINE LOCKED IN"}),e.jsx("p",{className:"text-xs text-white/60 max-w-xs mx-auto leading-relaxed",children:"We've captured your project requirements. A creative representative will secure contact within 12 hours."})]}),e.jsx("button",{onClick:()=>{u(!1),n([]),d(""),l({name:"",email:"",phone:"",message:""})},className:"px-6 py-3 border border-white/20 hover:border-white text-xs font-bold uppercase tracking-widest rounded-full transition-all text-white/80 hover:text-white",children:"Start Another Entry"})]})}),e.jsxs("div",{className:"space-y-10",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-[0.2em] text-[#adfa3b] block",children:"1. What services are you targeting?"}),e.jsx("div",{className:"flex flex-wrap gap-2.5",children:k.map(t=>e.jsxs("div",{onClick:()=>y(t),className:`interactive-tag ${r.includes(t)?"active":""}`,children:[t,r.includes(t)&&e.jsx(f,{className:"text-[#adfa3b]"})]},t))})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-[0.2em] text-[#adfa3b] block",children:"2. Approx budget tier?"}),e.jsx("div",{className:"flex flex-wrap gap-2.5",children:S.map(t=>e.jsx("div",{onClick:()=>d(t),className:`interactive-tag ${c===t?"active":""}`,children:t},t))})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("span",{className:"text-[10px] font-bold uppercase tracking-[0.2em] text-[#adfa3b] block mb-6",children:"3. Share your details"}),e.jsxs("div",{className:"cyber-input-wrap",children:[e.jsx("input",{required:!0,type:"text",id:"contact_name",value:a.name,onChange:p("name"),placeholder:" ",className:"cyber-input"}),e.jsx("label",{htmlFor:"contact_name",className:"cyber-input-label",children:"Your Name *"}),e.jsx("div",{className:"cyber-input-line"})]}),e.jsxs("div",{className:"cyber-input-wrap",children:[e.jsx("input",{required:!0,type:"email",id:"contact_email",value:a.email,onChange:p("email"),placeholder:" ",className:"cyber-input"}),e.jsx("label",{htmlFor:"contact_email",className:"cyber-input-label",children:"Email Address *"}),e.jsx("div",{className:"cyber-input-line"})]}),e.jsxs("div",{className:"cyber-input-wrap",children:[e.jsx("input",{type:"tel",id:"contact_phone",value:a.phone,onChange:p("phone"),placeholder:" ",className:"cyber-input"}),e.jsx("label",{htmlFor:"contact_phone",className:"cyber-input-label",children:"Phone Number"}),e.jsx("div",{className:"cyber-input-line"})]}),e.jsxs("div",{className:"cyber-input-wrap",children:[e.jsx("textarea",{required:!0,rows:4,id:"contact_msg",value:a.message,onChange:p("message"),placeholder:" ",className:"cyber-input",style:{resize:"none"}}),e.jsx("label",{htmlFor:"contact_msg",className:"cyber-input-label",children:"Tell us about your project *"}),e.jsx("div",{className:"cyber-input-line"})]})]}),e.jsx("div",{children:e.jsxs("button",{type:"submit",disabled:x,onClick:async t=>{if(t.preventDefault(),a.name&&a.email&&a.message){h(!0);const i={...a,access_key:"630055c9-f103-4cf8-a3d9-296452634b67",subject:"New Lead from Contact Page",from_name:"Buzziwah Website",services:r.join(", "),budget:c};try{const m=await(await fetch("https://api.web3forms.com/submit",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(i)})).json();m.success?u(!0):alert(m.message||"Something went wrong")}catch{alert("Error connecting to the server")}finally{h(!1)}}else alert("Please fill in all required fields marked with *")},className:"submit-btn",style:{width:"100%",justifyContent:"center",opacity:x?.7:1},children:[x?"Processing...":"Submit Proposal"," ",e.jsx(T,{size:18})]})})]})]})]}),e.jsx("div",{className:"mt-24 w-full",children:e.jsx("div",{style:{borderRadius:"32px",overflow:"hidden",border:"1px solid rgba(255, 255, 255, 0.08)",boxShadow:"0 30px 80px rgba(0, 0, 0, 0.4)"},children:e.jsx("iframe",{title:"Sripada Studios Location map",src:"https://www.google.com/maps?q=No.4/2,+1st+Main+Road,+West+of+Chord+Road,+Rajajinagar+Industrial+Town,+Bengaluru+560010&output=embed",style:{width:"100%",height:420,border:"none",filter:"invert(90%) hue-rotate(180deg) contrast(110%) opacity(0.8)"},loading:"lazy",referrerPolicy:"no-referrer-when-downgrade"})})})]})]})}export{q as default};
