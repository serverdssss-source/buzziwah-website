import{r as s,j as e}from"./react-core-CFCE4xZu.js";import{i as b,C as g,D as m,E as h,G as x,H as f,J as u,K as y,L as v}from"./icons-DS3HIroC.js";const j=()=>{const[i,c]=s.useState(0),[a,l]=s.useState(Array(8).fill(!1)),d=[{id:1,title:"Branding",sub:"Identity & Voice",icon:e.jsx(g,{}),href:"/branding",color:"#adfa3b",image:"/grid/brand.webp",description:"Creating cohesive brands, logos, guidelines, custom typography and tone frameworks."},{id:2,title:"Photography",sub:"Product & Portfolio",icon:e.jsx(m,{}),href:"/video-production",color:"#8b5cf6",image:"/grid/photograpohy.webp",description:"Stunning high-fidelity digital captures, creative model shoots, and studio product photography."},{id:3,title:"Content Solutions",sub:"Creative Copywriting",icon:e.jsx(h,{}),href:"/content-solution",color:"#8888a8",image:"/grid/content.webp",description:"Engaging narratives, SEO articles, and conversion-centered copywriting designed to attract attention."},{id:4,title:"Social SMM",sub:"Organic Growth",icon:e.jsx(x,{}),href:"/social-media",color:"#adfa3b",image:"/grid/social media manegementpng.webp",description:"Build organic presence, capture viral short-form video loops, and cultivate highly active communities."},{id:5,title:"Video Production",sub:"High-End Cinematic",icon:e.jsx(f,{}),href:"/video-production",color:"#8b5cf6",image:"/grid/video.webp",description:"Directing, shooting and editing professional short films, reels, and stunning high-retention social ads."},{id:6,title:"Web Dev",sub:"Sleek & Interactive",icon:e.jsx(u,{}),href:"/website-development",color:"#adfa3b",image:"/grid/web devlopmnnt.webp",description:"Building blazing-fast, pixel-perfect, highly responsive reactive web experiences."},{id:7,title:"SEO Solutions",sub:"Search Authority",icon:e.jsx(y,{}),href:"/seo",color:"#8888a8",image:"/grid/seo.webp",description:"On-page technical auditing, link acquisition, and keyword optimization to claim organic page-one positions."},{id:8,title:"Performance Ads",sub:"ROAS & Scaled Budgets",icon:e.jsx(v,{}),href:"/performance-marketing",color:"#8b5cf6",image:"/grid/performance markting.webp",description:"Precision-targeted paid search and social campaigns tailored for consistent return on ad spend."}],p=(t,o,r)=>{r.stopPropagation();const n=[...a];n[t]=!0,l(n),setTimeout(()=>{window.location.href=o},500)};return e.jsxs("div",{className:"upscale-wrapper",children:[e.jsx("style",{children:`
        .upscale-wrapper {
          background: #060811;
          color: white;
          padding: 120px 24px;
