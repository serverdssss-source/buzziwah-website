import{r as o,j as e,g as d}from"./animation-vendor-CdhPfQVW.js";import{V as m}from"./VariableProximity-DeLlx-a1.js";import{s as g}from"./servicesData-CBjG5fGf.js";import{S as h}from"./ScrollTrigger-D1XJUMov.js";import{a as f,S as u}from"./Section10-Cet8M2d1.js";const c=g["website-development"],b=()=>{const n=o.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("section",{className:"page-banner-section",ref:n,children:e.jsxs("div",{className:"coded-page-banner",children:[e.jsx("div",{className:"coded-page-banner-grid"}),e.jsx("div",{className:"coded-page-banner-purple-glow"}),e.jsx("div",{className:"coded-page-banner-green-glow"}),e.jsx("div",{className:"coded-page-banner-particles",children:Array.from({length:15}).map((t,a)=>{const i=`${Math.random()*100}%`,r=`${Math.random()*100}%`,s=`${Math.random()*3+1.5}px`,l=`${Math.random()*-20}s`,p=`${Math.random()*10+15}s`;return e.jsx("div",{className:"coded-banner-particle",style:{left:i,top:r,width:s,height:s,animationDelay:l,animationDuration:p}},a)})}),e.jsxs("div",{className:"flex flex-col items-center justify-center w-full max-w-[900px] gap-6 px-6 z-10 text-center relative",children:[e.jsx("div",{className:"absolute left-[-100px] top-[-50px] w-[500px] h-[1px] bg-[#adfa3b]/20 rotate-[-12deg] pointer-events-none"}),e.jsx("div",{className:"absolute right-[-100px] bottom-[-50px] w-[500px] h-[1px] bg-purple-500/10 rotate-[-12deg] pointer-events-none"}),e.jsxs("div",{className:"flex flex-col items-center text-center relative z-10",children:[e.jsx("div",{className:"coded-page-banner-badge",children:c.badge}),e.jsx("h1",{className:"coded-page-banner-title text-center skew-x-[-4deg] mb-4",style:{letterSpacing:"-0.03em"},children:e.jsx(m,{label:`${c.title} ${c.accentTitle}`,fromFontVariationSettings:"'wght' 400, 'opsz' 9",toFontVariationSettings:"'wght' 1000, 'opsz' 40",containerRef:n,radius:100,falloff:"linear"})}),e.jsx("div",{className:"h-[2px] w-24 bg-[#adfa3b] my-4 rounded-full"}),e.jsx("p",{className:"coded-page-banner-subtitle text-center max-w-[650px] mx-auto",children:c.subtitle})]})]})]})})]})};function y(){return null}const w=()=>{const n=["WE DESIGN","WE DEVELOP","WE PRMOTE","WE GROW"];return e.jsxs("section",{style:{background:"linear-gradient(135deg, #070312 0%, #150930 50%, #070312 100%)",padding:"0",overflow:"hidden",position:"relative"},children:[e.jsx("div",{style:{position:"absolute",top:"50%",left:"5%",width:80,height:80,borderRadius:"50%",background:"rgba(124,58,237,0.55)",filter:"blur(22px)",transform:"translateY(-50%)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",top:"50%",right:"6%",width:60,height:60,borderRadius:"50%",background:"rgba(124,58,237,0.45)",filter:"blur(18px)",transform:"translateY(-50%)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",top:"10%",left:"30%",width:40,height:40,borderRadius:"50%",background:"rgba(124,58,237,0.3)",filter:"blur(14px)",pointerEvents:"none"}}),e.jsx("div",{className:"marquee-row",style:{display:"flex",width:"100%"},children:n.map((t,a)=>e.jsxs("div",{className:"marquee-item",style:{flex:1,minWidth:0,display:"flex",alignItems:"center",justifyContent:"center",position:"relative"},children:[e.jsx("span",{style:{fontFamily:"'Syne', sans-serif",fontSize:"clamp(18px, 2.5vw, 38px)",fontWeight:800,color:"#c8ff00",letterSpacing:"0.06em",textTransform:"uppercase",whiteSpace:"nowrap",textAlign:"center"},children:t}),a<n.length-1&&e.jsx("div",{className:"marquee-divider",style:{position:"absolute",right:0,width:2,height:32,background:"#5b21b6"}})]},a))}),e.jsx("style",{children:`
        .marquee-item {
          padding: 52px 8px;
        }
    ...
    `})]}),A=()=>{const n=["/corsal/image.png","/corsal/2.png","/corsal/3.png","/corsal/4.png","/corsal/5.png","/corsal/6.png","/corsal/7.png"];return e.jsxs("section",{style:{background:"#0d0d1a",padding:"80px 0",overflow:"hidden",position:"relative"},children:[e.jsx("div",{style:{position:"absolute",top:"20%",left:"5%",width:200,height:200,borderRadius:"50%",background:"rgba(124,58,237,0.15)",filter:"blur(60px)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",bottom:"20%",right:"5%",width:180,height:180,borderRadius:"50%",background:"rgba(124,58,237,0.1)",filter:"blur(50px)",pointerEvents:"none"}}),e.jsx("h2",{className:"section6-headline",style:{fontFamily:"'Syne', sans-serif",fontWeight:800,color:"#c8ff00",textAlign:"center",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:60,position:"relative",zIndex:1},children:"A GLIMPSE INTO OUR IMPACTFUL SOLUTIONS"}),e.jsx("div",{style:{display:"flex",width:"max-content",gap:30,animation:"carouselScroll 35s linear infinite",padding:"0 20px"},children:[...n,...n,...n].map((t,a)=>e.jsx("div",{className:"carousel-card",style:{flexShrink:0,aspectRatio:"9/16",borderRadius:12,overflow:"hidden",boxShadow:"0 10px 40px rgba(0,0,0,0.6)",border:"2px solid rgba(255,255,255,0.05)",background:"#1a1a2e",transition:"transform 0.4s ease",cursor:"pointer"},children:e.jsx("img",{src:t,alt:`Solution ${a}`,style:{width:"100%",height:"100%",objectFit:"cover"},onError:i=>{i.target.style.display="none",i.target.parentElement.style.background="#1a1a2e"}})},a))}),e.jsx("style",{children:`
